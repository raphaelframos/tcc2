...
\pagenumbering{gobble}\newcommand{\titulo}{\MakeUppercase{Protótipo de automação alimentícia para pets}}\newcommand{\data}{09/12/2019}\newcommand{\alunoum}{Matheus Lima da Silva}\newcommand{\alunodois}{César Junior Penna Liberatori Matheus}\newcommand{\orientador}{Fábio Machado}\begin{document}
