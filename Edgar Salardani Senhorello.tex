...
\pagenumbering{gobble}\newcommand{\titulo}{\MakeUppercase{O estudo de caso de uma aplicação de rede social para dispositivos móveis como ferramenta na prevenção da violência contra a mulher}}\newcommand{\data}{09/12/2019}\newcommand{\alunoum}{Edgar Salardani Senhorello}\newcommand{\alunodois}{Marcius Ribeiro Vianna}\newcommand{\orientador}{Raphael Ferreira Ramos}\begin{document}
