...
\pagenumbering{gobble}\newcommand{\titulo}{\MakeUppercase{Desenvolvimento de um sistema com foco na produção de conteúdos EAD}}\newcommand{\data}{09/12/2019}\newcommand{\alunoum}{Pedro Oliveira Freire}\newcommand{\alunodois}{}\newcommand{\orientador}{João Victor Oliveira Costa}\begin{document}
