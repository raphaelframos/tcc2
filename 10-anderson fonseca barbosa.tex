...
\newcommand{\titulo}{\MakeUppercase{Sistema de informação para o controle de atividades internas aplicado a uma pequena empresa no ramo de confecções}}\newcommand{\data}{10/12/2019}\newcommand{\alunoum}{Anderson Fonseca Barbosa}\newcommand{\alunodois}{}\newcommand{\orientador}{Raphael Ferreira Ramos}\newcommand{\datacompleta}{10 de dezembro de 2019}\newcommand{\profum}{Matheus Mattos}\newcommand{\profdois}{Jamil Bussade}\begin{document}
