...
\pagenumbering{gobble}\newcommand{\titulo}{\MakeUppercase{Controle Interno de depertamento acadêmico (CIDA): Uma proposta de aplicativo para gestão de rotina de tutores}}\newcommand{\data}{09/12/2019}\newcommand{\alunoum}{Gabriel Pinto Soares}\newcommand{\alunodois}{Arthur dos Santos Xavier}\newcommand{\orientador}{Jamil Bussade Neto}\begin{document}
