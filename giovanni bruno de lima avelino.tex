...
\newcommand{\titulo}{\MakeUppercase{Aplicativo para acompanhamento educacional do aluno em sala de aula e acompanhamento do professor no processo de aprendizagem}}\newcommand{\data}{10/12/2019}\newcommand{\alunoum}{Giovanni Bruno de Lima Avelino}\newcommand{\alunodois}{}\newcommand{\orientador}{Raphael Ferreira Ramos}\newcommand{\datacompleta}{null}\newcommand{\profum}{Flávio Terra}\newcommand{\profdois}{Joelmir Vinhosa Canazaro}\begin{document}
