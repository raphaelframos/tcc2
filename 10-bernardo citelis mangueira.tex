...
\end{center}
\vspace{1cm}
\hspace{1cm}Declaramos, para os devidos fins, que o professor \textbf{\profum}\hspace{1mm}participou como presidente da defesa do trabalho intitulado \titulo, desenvolvido pelos alunos \emph{\alunoum}\hspace{1mm}e \emph{\alunodois}, regularmente matriculados na disciplina Trabalho de Conclusão de Curso II do 8º período do curso de Sistemas de Informação do Centro Universitário Redentor.
