...
\newcommand{\titulo}{\MakeUppercase{Estudo e análise de ferramentas anti-trapaça do jogo counter-strike: global offensive}}\newcommand{\data}{10/12/2019}\newcommand{\alunoum}{Bernardo Citelis Mangueira}\newcommand{\alunodois}{Ediandro Ferreira}\newcommand{\orientador}{Fábio Machado}\newcommand{\datacompleta}{10 de dezembro de 2019}\newcommand{\profum}{Ítalo Coutinho dos Santos}\newcommand{\profdois}{Thiago Ximenes}\begin{document}
...
\end{center}
\vspace{1cm}
\hspace{1cm}Declaramos, para os devidos fins, que o professor \textbf{\profum}\hspace{1mm}participou como examinador da defesa do trabalho intitulado \titulo, desenvolvido pelos alunos \emph{\alunoum}\hspace{0.7mm}e \emph{\alunodois}, regularmente matriculados na disciplina Trabalho de Conclusão de Curso II do 8º período do curso de Sistemas de Informação do Centro Universitário Redentor.\egroup
...
\end{center}
\vspace{1cm}
\hspace{1cm}Declaramos, para os devidos fins, que o professor \textbf{\profum}\hspace{1mm}participou como presidente da defesa do trabalho intitulado \titulo, desenvolvido pelos alunos \emph{\alunoum}\hspace{0.7mm}e \emph{\alunodois}, regularmente matriculados na disciplina Trabalho de Conclusão de Curso II do 8º período do curso de Sistemas de Informação do Centro Universitário Redentor.
